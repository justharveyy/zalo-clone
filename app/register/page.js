                    ...
                    <div className="w-full bg-white h-fit">
                        <div className="p-10 shadow-lg">
                            <form onSubmit={loginHandler}>
                                ...
                                <button type="submit" disabled={submitting} className="bg-[#0191f4] p-2 w-full text-white font-semibold mb-3 text-sm border border-1 border-[#0191f4]">Đăng ký</button>
                            </form>
                            <button onClick={() => { router.push('/login') }} className="border border-1 hover:border-[#0191f4] p-2 w-full font-semibold mb-3 text-[#0191f4] text-sm">Đăng nhập</button>
                        </div>
                    </div>
                </div>
            </div>
